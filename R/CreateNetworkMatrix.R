...
#'
#' @description This function creates a network matrix with zero diagonal and non-negative off-diagonal used to calculate Laplacian matrix and of dimention \eqn{pxp}.
...
#' 
#' @param x input matrix \eqn{nxp}. Each row is an observation vector.
