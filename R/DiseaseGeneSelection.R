#' @title Selection of cancer-specific genes
#'
...
#' a data frame of the disease genes composed by entrezgene_id, external_gene_name, DOID accession and probability score.
#' It is saved as .txt file in the current directory.
#' @export
